...
| [induced](https://browse.new/)                               |                                                              |                      |              | nice product for browser btask                               |                  |                           |
...
[WindowsAgentArena](https://github.com/microsoft/WindowsAgentArena): Evaluating multi modal os agents at scale



| Project                                                      | TAG                                             | driven method | supported by     | recommend reason                                             | C1m/Contributors | Star(k)/Fork(k)/PR/Issues |
| ------------------------------------------------------------ | ----------------------------------------------- | ------------- | ---------------- | ------------------------------------------------------------ | ---------------- | ------------------------- |
| [navi](https://github.com/microsoft/WindowsAgentArena/tree/main/src/win-arena-container/client/mm_agents/navi) |                                                 |               | microsoft        | It is integrated in WindowsAgentArena<br /><br />contains:<br />1. element_extractor<br />2. groundingdino<br />3. ocr<br />4. element_extractor<br /> |                  |                           |
