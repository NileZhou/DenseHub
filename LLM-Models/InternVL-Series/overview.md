...
InternVLChatModel(
  ...
  (language_model): Qwen2ForCausalLM(
    (model): Qwen2Model(
      (embed_tokens): Embedding(151674, 5120)
      (layers): ModuleList(
        (0-63): 64 x Qwen2DecoderLayer(
          (self_attn): Qwen2Attention(
            (q_proj): Linear8bitLt(in_features=5120, out_features=5120, bias=True)
            (k_proj): Linear8bitLt(in_features=5120, out_features=1024, bias=True)
            (v_proj): Linear8bitLt(in_features=5120, out_features=1024, bias=True)
            (o_proj): Linear8bitLt(in_features=5120, out_features=5120, bias=False)
            (rotary_emb): Qwen2RotaryEmbedding()
          )
          (mlp): Qwen2MLP(
            (gate_proj): Linear8bitLt(in_features=5120, out_features=27648, bias=False)
            (up_proj): Linear8bitLt(in_features=5120, out_features=27648, bias=False)
            (down_proj): Linear8bitLt(in_features=27648, out_features=5120, bias=False)
            (act_fn): SiLU()
          )
    ...
    (lm_head): Linear8bitLt(in_features=5120, out_features=151674, bias=False)
  )
  (mlp1): Sequential(
    (0): LayerNorm((12800,), eps=1e-05, elementwise_affine=True)
    (1): Linear8bitLt(in_features=12800, out_features=5120, bias=True)
...
核心生成代码:
root/.cache/huggingface/modules/transformers_modules/InternVL2_5-38B/modeling_internvl_chat.py
```python
